...
c.colors.downloads.error.bg = base0E
...
c.fonts.debug_console = '12pt Share Tech Mono'

c.fonts.default_family = ['8pt Sans', '10pt Sans']

c.fonts.default_size = '10pt'

c.fonts.downloads = '8pt Sans'

c.fonts.hints = '10pt Share Tech Mono'
...
config.bind('dev', 'devtools bottom')
config.bind('yy', 'yank')
