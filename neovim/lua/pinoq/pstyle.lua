...
vim.api.nvim_set_hl(0, "RainbowRed", { fg = base16_cs.colors.base01 })
vim.api.nvim_set_hl(0, "RainbowYellow", { fg = base16_cs.colors.base02 })
vim.api.nvim_set_hl(0, "RainbowBlue", { fg = base16_cs.colors.base03 })
vim.api.nvim_set_hl(0, "RainbowOrange", { fg = base16_cs.colors.base04 })
vim.api.nvim_set_hl(0, "RainbowGreen", { fg = base16_cs.colors.base05 })
vim.api.nvim_set_hl(0, "RainbowViolet", { fg = base16_cs.colors.base06 })
vim.api.nvim_set_hl(0, "RainbowCyan", { fg = base16_cs.colors.base07 })
vim.api.nvim_set_hl(0, "MiniStatuslineModeNormal", { bg = base16_cs.colors.base05, fg = base16_cs.colors.base00 })
vim.api.nvim_set_hl(0, "MiniStatuslineModeInsert", { bg = base16_cs.colors.base0F, fg = base16_cs.colors.base00 })
